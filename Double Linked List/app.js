class Producto{
  ...
  info(){
      ...
      +"<br>"+"Price: "+this.Precio+
      "<br>"+"ID: "+this.ID+"<br>"
      +"Quantity: "+this.Cantidad+"<br>";
  }
}
...
function Buscar(){
  ...
  if (search==null) {
      document.getElementById("resultado").innerHTML="Enter the ID";
      document.getElementById("textoabuscar").value="";
  }else{
      document.getElementById("resultado").innerHTML="I have this info <br>"+search.info();
      document.getElementById("textoabuscar").value="";
